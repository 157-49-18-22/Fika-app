...
const CategoryProducts = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        // Import Firebase functions to fetch products
        const { getWishGenieProducts } = await import('../../firebase/firestore');
        
        // Fetch products from backend
        const backendProducts = await getWishGenieProducts();
        ...
        const allProducts = [...backendProducts, ...regularProducts];
