...
import '../styles/FashionSection.css';
...
const fashionData = [
  { id: 3, image: fashion3, category: 'Summer Collection', title: 'Casual Elegance' },
  { id: 4, image: fashion4, category: 'Street Style', title: 'Urban Chic' },
  { id: 1, image: fashion1, category: 'Evening Wear', title: 'Classic Glamour' },
  { id: 5, image: fashion5, category: 'Seasonal Trends', title: 'Modern Essentials' },
  { id: 13, image: fashion13, category: 'Designer Picks', title: 'Luxury Edit' },
  { id: 10, image: fashion10, category: 'Accessories', title: 'Statement Pieces' },
      ...
      <div className="quick-view-content" onClick={e => e.stopPropagation()}>
        ...
        <div className="quick-view-details">
          ...
          <div className="quick-view-description">
            <p>Experience the perfect blend of style and comfort with our carefully curated fashion collection. Each piece is selected to help you express your unique personality while staying on trend.</p>
          </div>
