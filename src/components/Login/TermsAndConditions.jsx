        ...
        <div className="terms-content">
          {activeTab === 'return' ? (
            <div className="policy-content">
              ...
              <p>If the customer is unsatisfied with the product delivered then he/she needs to mail us at info@fika-india.com within 2 days from the date of receiving the parcel or register a return pickup from the tab "exchange & return" on the home page. FIKA will arrange a pick-up from your place (reverse pick-up may not be available on selected pin -codes). We have two options for processing such returns :-</p>
              <ol>
            ...
            <div className="policy-content">
              ...
              <ol>
                ...
                <li>For orders below Rs.2999/-, flat shipping of Rs.200/- is chargeable.</li>
