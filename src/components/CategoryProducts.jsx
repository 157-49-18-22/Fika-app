...
const CategoryProducts = () => {
      ...
      try {
        ...
        const mockProducts = [
          ...
          },
          {
            ...
            name: "Cartier Tank",
            price: 95000,
            image: 'https://images.unsplash.com/photo-1639037687665-8d5071445873?w=800',
            brand: 'Cartier',
            style: 'Luxury',
            material: 'Rose Gold',
            category: 'luxury-watches',
          ...
          },
          {
            ...
            name: "IWC Portuguese",
            price: 82000,
            image: 'https://images.unsplash.com/photo-1639037687862-3eaaeb906d49?w=800',
            brand: 'IWC',
            style: 'Luxury',
            material: 'Ceramic',
            category: 'luxury-watches',
          ...
          },
          {
            ...
            price: 1199,
            image: 'https://images.unsplash.com/photo-1596993100471-c3905dafa78e?w=800',
            brand: 'Forever 21',
            style: 'Casual',
            material: 'Cotton',
            size: 'M',
          ...
          },
          {
            ...
            price: 4499,
            image: 'https://images.unsplash.com/photo-1576663042137-e71d9e98579c?w=800',
            brand: 'Forever New',
            style: 'Party',
            material: 'Silk',
            size: 'M',
          ...
          // Evening Gowns
          {
            ...
            price: 5999,
            image: 'https://images.unsplash.com/photo-1559034750-cdab70a66b8e?w=800',
            brand: 'Forever New',
            style: 'Formal',
            material: 'Silk',
            size: 'M',
          ...
          // Men's Fashion - Suits
          {
            ...
            price: 12999,
            image: 'https://images.unsplash.com/photo-1594938374182-f8830bea75fe?w=800',
            brand: 'Raymond',
            color: 'Black',
            size: '40',
            category: 'mens-fashion',
          ...
          },
          {
            ...
            price: 8999,
            image: 'https://images.unsplash.com/photo-1592878940526-0214b0f374f6?w=800',
            brand: 'Arrow',
            color: 'Navy',
            size: '42',
            category: 'mens-fashion',
          ...
          },
          {
            ...
            price: 1599,
            image: 'https://images.unsplash.com/photo-1622290319146-7b63df48a635?w=800',
            brand: 'Marks & Spencer',
            color: 'Navy',
            size: '7-8Y',
            category: 'kids-fashion',
          ...
          // Electronics
          {
            ...
            price: 9999,
            image: 'https://images.unsplash.com/photo-1605464315542-bda3e2f4e605?w=800',
            brand: 'Apple',
            color: 'White',
        ...
        const filteredMockProducts = mockProducts.filter(product => {
          console.log('Filtering product:', product.category, 'against categoryName:', categoryName);
          if (categoryName === 'all') return true;
          return product.category === categoryName || product.subcategory === categoryName;
        });
  ...
  const filteredProducts = products.filter(product => {
    ...
    const styleMatch = selectedFilters.styles.length === 0 || 
                      (product.style && selectedFilters.styles.includes(product.style));
    const materialMatch = selectedFilters.materials.length === 0 || 
                        (product.material && selectedFilters.materials.includes(product.material));
    const brandMatch = selectedFilters.brands.length === 0 || 
  ...
  return (
    <div className="category-products">
      ...
      <div className="category-content">
        <FilterSection className={`category-filters ${showFilters ? 'show' : ''}`}>
          ...
          <div className="filter-group">
            <h3>
              Price Range
              <span className="count">₹{selectedFilters.priceRange[0].toLocaleString()} - ₹{selectedFilters.priceRange[1].toLocaleString()}</span>
            </h3>
          ...
          <div className="filter-group">
            <h3>
              Style
              <span className="count">{selectedFilters.styles.length} selected</span>
            </h3>
          ...
          <div className="filter-group">
            <h3>
              Material
              <span className="count">{selectedFilters.materials.length} selected</span>
            </h3>
            <div className="checkbox-group">
              {getMaterialOptions().map(material => {
                const count = products.filter(p => p.material === material).length;
                return (
                  <label key={material}>
                    <input
                      type="checkbox"
          ...
          <div className="filter-group">
            <h3>
              Brands
              <span className="count">{selectedFilters.brands.length} selected</span>
            </h3>
            <div className="checkbox-group">
